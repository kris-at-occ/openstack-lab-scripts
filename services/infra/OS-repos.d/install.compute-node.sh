...
SCRIPT_NAME="services/infra/OS-repos.d/install.compute-node.sh"

# This file contains script to Install OpenStack Infrastructure OpenStack Repository files on Compute Node
