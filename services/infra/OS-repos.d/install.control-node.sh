...
SCRIPT_NAME="services/infra/OS-repos.d/install.control-node.sh"

# This file contains script to Install OpenStack Infrastructure OpenStack Repository files on Control Node
