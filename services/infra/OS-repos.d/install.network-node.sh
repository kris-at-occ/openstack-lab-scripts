...
SCRIPT_NAME="services/infra/OS-repos.d/install.network-node.sh"

# This file contains script to Install OpenStack Infrastructure OpenStack Repository files on Network Node
